...
type FlatConfig struct {
	...
	VSIBootSnapshotID         *string           `mapstructure:"vsi_boot_snaphot_id" cty:"vsi_boot_snaphot_id" hcl:"vsi_boot_snaphot_id"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"vsi_boot_snaphot_id":          &hcldec.AttrSpec{Name: "vsi_boot_snaphot_id", Type: cty.String, Required: false},
