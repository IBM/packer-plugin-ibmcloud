...
type FlatConfig struct {
	...
	WinRMLoginPassword        *string           `mapstructure:"winrm_login_password" cty:"winrm_login_password" hcl:"winrm_login_password"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"winrm_login_password":         &hcldec.AttrSpec{Name: "winrm_login_password", Type: cty.String, Required: false},
