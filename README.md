...
| |
vsi_base_image_id | string | The base image identifier used to created the VSI to install desired applications & services. Use `ibmcloud is images | grep available` 
