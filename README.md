...
vsi_boot_vol_profile | string | User can provide the available profile for volume attachments. Supported profiles: `5iops-tier`, `10iops-tier`, `custom`, `general-purpose`, `custom`. Refer https://cloud.ibm.com/docs/vpc?topic=vpc-block-storage-profiles&interface=ui for profile info. Optional. 
