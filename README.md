...
vsi_data_vol_bandwidth | number | Optional | The maximum bandwidth (in megabits per second) for the data volume. Only honored when `vsi_data_vol_profile` is `custom` or `sdp`. If unset, IBM Cloud assigns a default for the profile.
